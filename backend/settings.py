...
SECRET_KEY = 'django-insecure-26%j-o%p-*q)*p$)7(&od_6!x32fj7k#1^ug)^c5j(w+us5%a6'
...
MIDDLEWARE = [
    ...
    "django.middleware.csrf.CsrfViewMiddleware",  # keep AFTER common middleware
